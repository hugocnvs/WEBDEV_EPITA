<?php
	...
	if(isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['username']) && isset($_POST['password']))
	{
	    ...
	    {
	        $requete = "INSERT INTO web_co(CO_Nom, CO_Prenom, CO_Username, CO_Password) VALUES($nom, $prenom, $username,$password)";
	    ...
	    {
	       header('Location: register.php?erreur=2'); // utilisateur ou mot de passe vide
	    }
	}
	else
	{
